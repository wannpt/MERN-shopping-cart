...
const HomePage = () => {
    return (
        <div className='lg:px-48 md:px-24 pb-4'>
            <span className='text-xl font-medium'>Latest Products</span>
            <div className='container grid gap-4 md:grid-cols-2 lg:grid-cols-4 mt-4'>
